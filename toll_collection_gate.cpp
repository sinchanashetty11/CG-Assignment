...
void init(void)
{
	glClearColor(0.18, 0.83, 0.78, 0.0);
...
int main(int argc,char **argv)
{
		...
		glutCreateWindow("TOLL COLLECTING GATE");
		init();
...
static void key(unsigned char key1, int x, int y)
{
	...
	void welcome()
	{
			...
			glColor3f(1.0,1.0,1.0);
	 		drawstring(150,400,0.0,"PRESENTING");
			glColor3f(1.0,1.0,1.0);
	 		drawstring1(100,300,0.0," Computer Graphics Mini Project ");
	 		glColor3f(1.0,1.0,1.0);
	 		drawstring(180,260,0.0,"CSE - VI /C ");
	 		glColor3f(1.0,1.0,1.0);
		...
		void frontscreen()
	{
		...
		glColor3f(0.0,0.0,0.0);
	 		drawstring(110,470,0.0,"Computer Graphics");
	 		drawstring(290,470,0.0,"Mini ");
	 		drawstring(340,470,0.0,"Project");
	 	glColor3f(1.0,0.5,0.5);
	 		drawstring(70,410,0.0,"[TOLL");
	 		drawstring(170,410,0.0,"COLLECTING");
	 		drawstring(350,410,0.0,"GATE]");
	 	glColor3f(1.0,1.0,1.0);
	 	...
	 	glColor3f(0.0,0.0,1.0);
	 		drawstring2(20,260,0.0,"Sinchana Shetty                   1BY18CS165");
	 		drawstring2(20,290,0.0,"Vanshika Sharma                   1BY18CS185");
	 		drawstring2(20,230,0.0,"Varsha Bang                       1BY18CS186");
	 	glColor3f(1.0,1.0,1.0);
	 		drawstring1(150,200,0.0,"Under the Guidance of");
	 	glColor3f(1.0,1.0,0.0);
	 		drawstring2(160,170,0.0,"Prof. Shankar R ");
	 	glColor3f(0.0,0.0,0.0);
	 		drawstring1(170,130,0.0,"Year:-2020-21 ");
	...
	else
	{
		...
		glEnd();
			...
			// display instruction for left car
				...
				glColor3f(0.0,0.0,0.0);
				drawstring1(ax+410,60,0,"Car nano");
				drawstring1(ax+410,50,0,"instructions:");
		 		drawstring1(ax+410,40,0,"r:open barrier");
		 		drawstring1(ax+410,30,0,"n:speed up");
				drawstring1(ax+410,20,0,"m:speed down");
